...
const SettingsPages: Record<SettingsPageId, SettingsPageObject> = {
  download: {
    title: zhCN.settingsPages.download,
  ...
  connection: {
    title: zhCN.settingsPages.connection,
  ...
  speed: {
    title: zhCN.settingsPages.speed,
  ...
  bitTorrent: {
    title: zhCN.settingsPages.bitTorrent,
  ...
  webUi: {
    title: zhCN.settingsPages.webUi,
  ...
  advanced: {
    title: zhCN.settingsPages.advanced,
  ...
  updates: {
    title: zhCN.settingsPages.updates,
  ...
  searchPlugins: {
    title: zhCN.settingsPages.searchPlugins,
  ...
  categories: {
    title: zhCN.settingsPages.categories,
  ...
  fontSize: {
    title: zhCN.settingsPages.fontSize,
  ...
  mobileTabs: {
    title: zhCN.settingsPages.mobileTabs,
  ...
  integrations: {
    title: zhCN.settingsPages.integrations,
    icon: <IoExtensionPuzzle size={iconSize} />,
